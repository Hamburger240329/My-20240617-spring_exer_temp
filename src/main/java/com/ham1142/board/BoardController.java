...
//	public String wtrieOk( HttpServletRequest request, Model model) {
	public String wtrieOk(@ModelAttribute("bdto")  BoardDto boardDto, Model model ){
